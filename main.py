...
BACKGROUND = (192, 192, 192)  # BACKGROUND = (72, 61, 139)
FPS = 60
...
def make_buttons():
    ...
    buttons.append(Button(window, WIDTH // 1.25 - 50, 50, 100, 30, text='RESTART', colour=(117, 14, 14), hover_colour=(217, 54, 54),bold_text=True, function=reset_grid, state='paused'))
    buttons.append(Button(window, WIDTH // 4 - 50, 50, 100, 30, text='RESUME', colour=(28, 111, 51), hover_colour=(48, 131, 81),bold_text=True, function=run_game, state='paused'))
